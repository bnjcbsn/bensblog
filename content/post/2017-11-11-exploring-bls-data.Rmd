...
Then download all series data, except that this fails in webiste render, perhaps due to size:
...
Instad of all data, I'll download just the series that I'm seeking for this exercise.
```{r, eval=FALSE}
library(tidyverse)
...
My next steps will be to convert this to a time series, then create a plot.
