...
My first attempt to download follows. Notice that I've loaded no packages yet. This is base R. I copy in some code from the previous post just to see what happens.
```{r, eval=FALSE}
...
Mission accomplished. A lot more could be learned about the BLS data, but I'm satisfied with what I've accomplished in this process. I still have some Git pieces to put together also. I'd also like to learn to wrap a post like this up with a reference list.
```{r, include= FALSE}
