...
I became curious about this subject following a tweet by a bank with an infographic regarding the November jobs report. It dawned on me this public data may prove useful for a post as my professional work is intirely not public for sharing. I visited bls.gov to try to find out what is available and how to access it. There is a lot of data available and it's offered multiple ways. I always start out with a Google query and stackoverflow search. I discovered a package developed for this sake.
